...
/**
 *  NoSQL Version for CMPE281 Project
 *
 *@author     Paul Nguyen
...
public class SMImplVersion3 implements SM {
  ...
  /**
   *  Constructor for the SMImplVersion3 object
   *
   *@since
   */
  ...
  /**
   *  The main program for the SMImplVersion3 class
   *
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Storage Manager - Implementation Version 3.");
    
    try {

      // create a new SM
      SMImplVersion3 sm = new SMImplVersion3();
  ...
  public SM.OID getOID( byte[] oidbytes ) {
	   return new SMImplVersion3.OID( oidbytes ) ;	  
  }
